    ...
    <AppLayout>
      ...
      <div className="p-4 md:p-8">
        <Card className="max-w-xl mx-auto">
          <CardHeader><CardTitle>Generate Report</CardTitle><CardDescription>Click below to download a PDF summarizing key metrics like financials, fuel stock, and sales.</CardDescription></CardHeader>
          <CardContent className="flex flex-col items-center gap-4">
             <div className="flex items-center space-x-2"><Switch id="letterhead-switch" checked={printOnLetterhead} onCheckedChange={setPrintOnLetterhead}/><Label htmlFor="letterhead-switch">Print on Letterhead</Label></div>
            <Button onClick={handleDownloadPdf}><Download className="mr-2 h-4 w-4" />Download PDF Summary</Button>
          </CardContent>
        </Card>
      </div>
    </AppLayout>
