...
export default function DownloadReportPage() {
  ...
  const handleDownloadPdf = () => {
    ...
    if (printOnLetterhead) {
        // --- Indian Oil Logo ---
        // A smaller, more reliable Base64 string for the logo.
        const logoBase64 = 'data:image/png;base64,';
